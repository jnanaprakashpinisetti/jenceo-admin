...
const MultiStepForm = () => {
  ...
  const validateStep = (step) => {
    ...
    switch(step) {
      case 1:
        ...
        if (formData.aadharNo.length<12) newErrors.aadharNo = 'Must be 12 digits';
      ...
      case 5:
        ...
        if (formData.workExperience.length === 0) newErrors.workExperience = 'At least one work experience is required';
      ...
      case 7:
        if (!formData.emergencyContact1.name) newErrors.emergencyContact1 = {...newErrors.emergencyContact1, name: 'Name is required'};
        if (!formData.emergencyContact1.relation) newErrors.emergencyContact1 = {...newErrors.emergencyContact1, relation: 'Relation is required'};
        if (!formData.emergencyContact1.mobile1) {
          newErrors.emergencyContact1 = {...newErrors.emergencyContact1, mobile1: 'Mobile No. is required'};
        } else if (!validateMobileNumber(formData.emergencyContact1.mobile1)) {
          newErrors.emergencyContact1 = {...newErrors.emergencyContact1, mobile1: 'Mobile number must be 10 digits'};
        }
        if (formData.emergencyContact1.mobile2 && !validateMobileNumber(formData.emergencyContact1.mobile2)) {
          newErrors.emergencyContact1 = {...newErrors.emergencyContact1, mobile2: 'Mobile number must be 10 digits'};
        }
        break;
        
      case 8:
        if (!formData.emergencyContact2.name) newErrors.emergencyContact2 = {...newErrors.emergencyContact2, name: 'Name is required'};
        if (!formData.emergencyContact2.relation) newErrors.emergencyContact2 = {...newErrors.emergencyContact2, relation: 'Relation is required'};
        if (!formData.emergencyContact2.mobile1) {
          newErrors.emergencyContact2 = {...newErrors.emergencyContact2, mobile1: 'Mobile No. is required'};
        } else if (!validateMobileNumber(formData.emergencyContact2.mobile1)) {
          newErrors.emergencyContact2 = {...newErrors.emergencyContact2, mobile1: 'Mobile number must be 10 digits'};
        }
        if (formData.emergencyContact2.mobile2 && !validateMobileNumber(formData.emergencyContact2.mobile2)) {
          newErrors.emergencyContact2 = {...newErrors.emergencyContact2, mobile2: 'Mobile number must be 10 digits'};
        }
        break;
  ...
  const handleChange = (e) => {
    ...
    if (name === 'mobileNo1' || name === 'mobileNo2' || 
        name.includes('mobile1') || name.includes('mobile2')) {
  ...
  const handleBlur = (e) => {
    ...
    if (!value.trim()) {
      errorMessage = `${name.replace(/([A-Z])/g, ' $1').replace(/^./, str => str.toUpperCase())} is required`;
      isValid = false;
    } else {
