// src/pages/clients/DisplayHouseKeepingClient.js
 ...
 * Same functionality and look as DisplayClient but pulls data from:
 * HouseKeeping/ClientData/key
 */

export default function DisplayHouseKeepingClient() {
    ...
    // === Live join latest payment per client from DB (handles HouseKeeping/ClientData/<id>/Payments) ===
    useEffect(() => {
        ...
        clients.forEach((c) => {
            ...
            const payRefLower = firebaseDB.child(`HouseKeeping/ClientData/${c.id}/payments`);
            ...
            const payRefUpper = firebaseDB.child(`HouseKeeping/ClientData/${c.id}/Payments`);
    ...
    // Fetch + live updates from HouseKeeping/ClientData
    useEffect(() => {
        const ref = firebaseDB.child('HouseKeeping/ClientData');
    ...
    const handleSave = async (updatedClient) => {
        try {
            await firebaseDB.child(`HouseKeeping/ClientData/${updatedClient.id}`).update(updatedClient);
    ...
    if (loading) return <div className="text-center my-5">Loading housekeeping clients...</div>;
    if (error) return <div className="alert alert-danger">Error: {error}</div>;
    if (clients.length === 0) return <div className="alert alert-info">No housekeeping clients found</div>;

    return (
        <div className="display-client">
            <h3 className="mb-3">Housekeeping Clients</h3>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p className="mb-0">Are you sure you want to delete this housekeeping client?</p>
                                <p className="mt-2">
                                    <strong>ID:</strong> {clientToDelete.idNo || clientToDelete.id} <br />
                                    <strong>Name:</strong> {clientToDelete.clientName || 'N/A'}
                                </p>
                                <small className="text-muted">
                                    This will move the record to the <strong>HouseKeeping/ExitClients</strong> section.
                                </small>
                            </div>
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-danger" onClick={async () => {
                                    ...
                                    try {
                                        ...
                                        await firebaseDB.child(`HouseKeeping/ExitClients/${id}`).set({ ...payload, originalId: id, movedAt });
                                        await firebaseDB.child(`HouseKeeping/ExitClients/${id}/removalHistory`).push(removalEntry);
                                        await firebaseDB.child(`HouseKeeping/ClientData/${id}`).remove();
                                        ...
                                        console.error('Error moving housekeeping client with removal', err);
                ...
                <div className="modal fade show" style={{ display: 'block', backgroundColor: 'rgba(0,0,0,0.5)' }}>
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p>The housekeeping client has been moved to the <strong>HouseKeeping/ExitClients</strong> section.</p>
                            </div>
                            <div className="modal-footer">
                ...
                <div className="modal fade show" style={{ display: 'block', backgroundColor: 'rgba(0,0,0,0.5)' }}>
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p>Housekeeping client details have been updated.</p>
                            </div>
                            <div className="modal-footer">
