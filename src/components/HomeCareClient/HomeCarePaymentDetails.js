// HomeCarePaymentDetails.js
import React from "react";

const HomeCarePaymentDetails = ({ formData, handleChange, addPayment, removePayment, errors = {}, isViewMode = false }) => {
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="form-group">
                ...
                <input type="text" inputMode="numeric"
                  className={`form-control ${getErr(index, "receiptNo") ? "is-invalid" : ""}`}
                  name="receiptNo" value={payment.receiptNo || ""} onChange={(e) => handleChange(e, "payments", index)}
                  id={`receiptNo-${index}`} placeholder="Enter receipt number" readOnly={isViewMode} maxLength={3} />
                {getErr(index, "receiptNo") && <div className="invalid-feedback">{getErr(index, "receiptNo")}</div>}
              </div>
            </div>
            ...
            <div className="col-md-6">
              <div className="form-group">
                ...
                <input type="text" inputMode="numeric"
                  ...
                  id={`bookNo-${index}`} placeholder="Enter book number" readOnly={isViewMode} maxLength={3} />
          ...
          <div className="row">
            <div className="col-md-4">
              <div className="form-group">
                ...
                <input type="number" min="0"
                  ...
                  id={`reminderDays-${index}`} placeholder="Days" readOnly={isViewMode} maxLength={2} />
                {getErr(index, "reminderDays") && <div className="invalid-feedback">{getErr(index, "reminderDays")}</div>}
                <small className="form-text text-muted">Enter number of days (1-99)</small>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="form-group">
                ...
                <input type="date" className="form-control" name="reminderDate" value={payment.reminderDate || ""} 
                  onChange={(e) => handleChange(e, "payments", index)} id={`reminderDate-${index}`} min={minDateFormatted} 
                  readOnly={isViewMode ? true : false} />
                <small className="form-text text-muted">Auto-filled from Reminder Days</small>
              </div>
            </div>
          ...
          <div className="row mt-2">
            <div className="col-12">
              <div className="form-group">
                ...
                <textarea className="form-control" name="remarks" rows="3" value={payment.remarks || ""} 
                  onChange={(e) => handleChange(e, "payments", index)} id={`remarks-${index}`} 
                  placeholder="Any additional notes" readOnly={isViewMode} />
              </div>
            </div>
          </div>
...
export default HomeCarePaymentDetails;