...
// HousekeepingClientModal.js - Housekeeping Version
...
const HousekeepingClientModal = ({
  ...
  const removeAllPaymentReminders = async () => {
    try {
      ...
      for (let i = 0; i < count; i += 1) {
        tasks.push(
          firebaseDB
            .child(`HousekeepingClientData/${key}/payments/${i}/reminderDate`)
            .remove()
            .catch(() => { }),
        );
        tasks.push(
          firebaseDB
            .child(`HousekeepingClientData/${key}/payments/${i}/remindeDate`)
            .remove()
            .catch(() => { }),
        );
      }
  ...
  const updateLastReminderDate = async () => {
    ...
    if (key) {
      await firebaseDB
        .child(`HousekeepingClientData/${key}/payments/${idx}`)
            ...
            <div className="modal-header bg-secondary text-white justify-content-between">
              <div>
                <h5 className="modal-title">
                  {editMode ? <strong>Edit Housekeeping Client</strong> : <strong>View Housekeeping Client</strong>} — {formData.idNo} — {formData.clientName}
                </h5>
        ...
        <div className="modal fade show" style={{ display: "block", backgroundColor: "rgba(0,0,0,0.5)" }}>
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <p>Are you sure you want to delete this housekeeping client? This will move the data to the exited clients database.</p>
              </div>
              <div className="modal-footer">
        ...
        <div className="modal fade show" style={{ display: "block", backgroundColor: "rgba(0,0,0,0.5)" }}>
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <p>Are you sure you want to remove this housekeeping client?</p>
              ...
              <div className="modal-footer">
                ...
                <button className="btn btn-danger" onClick={async () => {
                  ...
                  try {
                    ...
                    if (id) {
                      await firebaseDB.child(`ExitHousekeepingClients/${id}/removalHistory`).push(removalEntry);
                    } else {
                      const newRef = firebaseDB.child(`ExitHousekeepingClients`).push();
...
export default HousekeepingClientModal;
