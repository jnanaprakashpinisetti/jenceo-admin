  ...
  return (
    <div className="p-3 bg-dark border rounded-3">
      ...
      {loading ? (
        ...
        <div className="mb-4">
        {/* Table Header */}
        <div className="row g-0 mb-2 rounded-top" style={{ background: 'linear-gradient(135deg, #1f2937 0%, #374151 100%)' }}>
          ...
          <div key={grp.title}>
            ...
            <div className="row g-0 mb-1 mt-3">
              <div className="col-12">
                <div className="d-flex align-items-center ps-3 py-2 rounded" style={{ background: 'rgba(59, 130, 246, 0.1)' }}>
                  <i className="fas fa-tag text-info me-2"></i>
                  <h6 className="text-info mb-0 small fw-bold">{grp.title}</h6>
                </div>
              </div>
            </div>
                ...
                >
                  ...
                  <div className="col-md-2 ps-3">
                    <div className="d-flex align-items-center">
                      <i className="fas fa-carrot text-warning me-2"></i>
                      <div>
                        <strong className="text-light d-block" style={{ fontSize: '0.9rem' }}>
                          {item.subCategory}
                        </strong>
                  ...
                  <div className="col-md-2 text-center">
                    <div className="d-flex align-items-center justify-content-center">
                      <span 
                        className="text-light fw-semibold px-3 py-1 rounded"
                        style={{ 
                          fontSize: '0.9rem',
