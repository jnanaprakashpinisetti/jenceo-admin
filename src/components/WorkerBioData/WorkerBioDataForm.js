...
const TOTAL_STEPS = 12; // Changed from 11 to 12

const initialFormData = {
  // Department fields
  department: "",
  role: "",
  idNo: "", // Auto-generated based on department
  joiningDate: "",
  supervisorId: "",
  supervisorName: "",
...
const WorkerBioDataForm = ({ isOpen = false, onClose = () => { }, onSaved }) => {
  ...
  // -------------------------------
  // Auto-generate ID (ONLY for Home Care - legacy compatibility)
  // -------------------------------
  useEffect(() => {
    if (!isOpen) {
      ...
      for (const node of nodesToCheck) {
        try {
          ...
          if (val) {
            ...
            return { recordId: key, ...val[key], dbNode: node };
          }
        } catch (innerErr) {
    ...
    if (type === "file") {
      ...
      if (!file) {
        setFormData((prev) => ({
          ...prev,
          [name + "File"]: null,
          ...(name === "employeePhoto" ? { employeePhotoPreview: "" } : {}),
        }));
        return;
      }
      ...
      // Create a live preview for Step 12 review
      if (name === "employeePhoto") {
        const reader = new FileReader();
        reader.onload = (ev) => {
          setFormData((prev) => ({
            ...prev,
            employeePhotoPreview: ev.target.result, // Step 12 uses this immediately
            employeePhotoUrl: ev.target.result,     // temporary so other views also see it
            _photoCacheBust: Date.now(),            // force <img> to refresh when switching steps
          }));
        };
        reader.readAsDataURL(file);
      }

      if (name === "idProof" && file.type !== validPdf && !validImage.includes(file.type)) {
  ...
  const checkValidationForStep = (s) => {
    ...
    switch (s) {
      ...
      case 7: { // Health Details
        break;
      }

      case 8: { // Emergency Contact 1
      ...
      case 10: { // Emergency Contact 3
        break;
      }

      case 11: { // Bank Details
  ...
  const renderStep = (s) => {
    ...
    switch (s) {
      case 1: return <Department {...common} />;
      case 2: return <BasicInformation {...common} />;
      case 3: return <PermanentAddress {...common} />;
      case 4: return <PresentAddress {...common} />;
      case 5: return <PersonalInformation {...common} />;
      case 6: return <QualificationSkills {...common} />;
      case 7: return <HealthDetails {...common} />;
      case 8: return <EmergencyContact1 {...common} />;
      case 9: return <EmergencyContact2 {...common} />;
      case 10: return <EmergencyContact3 {...common} />;
...
function stepTitleFor(idx) {
  switch (idx) {
    ...
    case 3: return "Permanent Address";
    case 4: return "Present Address";
    case 5: return "Personal Info";
    case 6: return "Qualification & Skills";
    case 7: return "Health Details";
    case 8: return "Emergency 1";
    case 9: return "Emergency 2";
    case 10: return "Emergency 3";
