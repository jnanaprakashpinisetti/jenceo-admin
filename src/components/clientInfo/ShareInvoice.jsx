...
const ShareInvoice = ({
    ...
    // Calculate auto-fill date (30 days from service date)
    ...
    const getPaymentDetails = () => {
        ...
        // Calculate next payment date (30 days from last payment or starting date)
    ...
    // Build client biodata table HTML (same style as ClientModal)
...
<style>
  *{box-sizing:border-box}
  ...
  .biodata-table-section th,
  .biodata-table-section td {
    padding: 8px;
    border: 1px solid #dee2e6;
    text-align: left;
    vertical-align: top;
  ...
  .comments-content {font-size: 12px; line-height: 1.5; color: #555}
...
<body>
<div class="page">
<div style="margin: -21px -20px 10px -20px"><img src="${headerImage}" alt="Header" style="width:100%" /></div>
  ...
  <div class="header">
    ...
    <div class="photo-box">
      <img src="${defaultCustomerPhoto}" alt="Client" style="width:120px;height:120px;object-fit:cover;border-radius:6px;border:1px solid #ccc" />
      <div class="rating" style="margin-top: 8px; padding:5px ">
 ...
 ${buildClientBiodataTable()}
  ...
  <div class="sec">
    ...
    <div class="sec-body">
      <div class="custom-invoice-section">
        ...
        ${invoiceData.remarks ? `
        <div style="margin-top: 15px; padding: 10px; background: white; border-radius: 6px; border: 1px solid #e5e5e5;">
          <div style="font-weight: 600; font-size: 12px; color: #555; margin-bottom: 5px;">Remarks</div>
          <div style="font-size: 13px; color: #333;">${invoiceData.remarks}</div>
        </div>
        ` : ''}
      </div>
    </div>
  ...
  <div class="thank-you">
    <h3 style="color:#02acf2; margin-bottom:10px">Thank You for Your Trust!</h3>
    <p style="margin:0">We appreciate your trust and look forward to continuing to serve you.</p>
    <p style="margin:5px 0 0 0"><strong>JenCeo Home Care & Traders</strong></p>
    <p style="margin:0; font-size:11px; color:#666">Quality Service | Trusted Care | Client Satisfaction</p>
  </div>
...
`;
    ...
    return (
        <>
            {showCustomInvoiceForm && <CustomInvoiceForm />}

            <div className="modal-card">
                <div className="modal-card-header d-flex align-items-center justify-content-between">
                    <h4 className="mb-0 text-info opacity-50">Invoice Preview - {generatedInvoiceNumber}</h4>
                ...
                <div className="modal-card-footer d-flex justify-content-between align-items-center p-3 border-top">
                    ...
                    <small className="text-muted">
                        ...
                        Next Payment: <strong className="text-info">
